...
| Document | Description |
|----------|-------------|
| [aimu_fabric_routing.md](aimu_fabric_routing.md) | Fabric routing: packet format, route report schema, route planning; **packet/barrier semantics frozen v1.0 at M160** (§1.3) |
