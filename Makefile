...
TEST_NAMES := smoke tensor matmul rmsnorm softmax rope silu swiglu \
	...
	q8_bench q8_cluster cuda_q8_cluster backend_matrix converter_validation quant_q4 quant_q4_pack matmul_q4 quant_q4_fixture infer_q4 cluster_infer_q4 q4_bench cuda_matmul_q4
